...
std::vector<double> getLut(const jetType & type){
   ...
   for(int i=0; i<48; i++){
     ...
     if(type==jetType::5400donut) lut.push_back(luts5400::donutLut[i]);
     else if(type==jetType::5400global) lut.push_back(luts5400::globalLut[i]);
     else if(type==jetType::5400nopus) lut.push_back(luts5400::nopusLut[i]);
     else if(type==jetType::5400donut20) lut.push_back(luts5400::donutLut20[i]);
     else if(type==jetType::5400global20) lut.push_back(luts5400::globalLut20[i]);
     else if(type==jetType::5400nopus20) lut.push_back(luts5400::nopusLut20[i]);
     else if(type==jetType::5400donut10) lut.push_back(luts5400::donutLut10[i]);
     else if(type==jetType::5400global10) lut.push_back(luts5400::globalLut10[i]);
     else if(type==jetType::5400nopus10) lut.push_back(luts5400::nopusLut10[i]);
     
     else if(type==jetType::5450donut) lut.push_back(luts5450::donutLut[i]);
     else if(type==jetType::5450global) lut.push_back(luts5450::globalLut[i]);
     else if(type==jetType::5450nopus) lut.push_back(luts5450::nopusLut[i]);
     else if(type==jetType::5450donut20) lut.push_back(luts5450::donutLut20[i]);
     else if(type==jetType::5450global20) lut.push_back(luts5450::globalLut20[i]);
     else if(type==jetType::5450nopus20) lut.push_back(luts5450::nopusLut20[i]);
     else if(type==jetType::5450donut10) lut.push_back(luts5450::donutLut10[i]);
     else if(type==jetType::5450global10) lut.push_back(luts5450::globalLut10[i]);
     else if(type==jetType::5450nopus10) lut.push_back(luts5450::nopusLut10[i]);
