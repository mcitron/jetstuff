...
process.source = cms.Source("PoolSource",
    ...
    #'file:/afs/cern.ch/work/j/jad/public/TriggerTowers_TTbar_13TeV_PU40_50ns_1-10_skimmed_v3.root'    
      'file:///afs/cern.ch/work/m/mcitron/public/QCD/output_run1.root'
    ),
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('/afs/cern.ch/work/m/mcitron/jadjets/CMSSW_6_2_0/src/jCaloTower/CaloTowerAnalyser/batch/qcd_new_calib_140603/output_run1.root')
