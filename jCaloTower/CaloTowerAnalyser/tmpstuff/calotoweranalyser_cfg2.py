...
process.source = cms.Source("PoolSource",
    ...
    '/store/user/jad/NeutrinoGun140PU_25Jun001/output-all_6_1_dTG.root'
#    'file:../../SLHCUpgradeSimulations/L1CaloTrigger/output-all-2.root'
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('histograms-3.root')
                                   )
