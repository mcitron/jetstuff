...
//   jettype.push_back("5450");
   ...
   for(auto iType = jettype.begin(); iType != jettype.end(); iType++){
      ...
      TH1D* nopus = f->Get(*iType+"_nopus/5400_nopusjet4");
      TH1D* donut = f->Get(*iType+"_donut/5400_donutjet4");
      TH1D* global = f->Get(*iType+"_global/5400_globaljet4");
      TH1D* gct = f->Get("gct/gctjet4");
