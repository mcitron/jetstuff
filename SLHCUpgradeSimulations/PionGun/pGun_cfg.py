...
process.load('Configuration.StandardSequences.MagneticField_38T_cff') #38 or 0
...
process.pfChargedHadronAnalyzer = cms.EDAnalyzer(
    ...
    rootOutputFile = cms.string("./partGun_PDGID_YYY.root"),# the root tree
