...
#UNCOMMENT HERE TO RUN ON DATA/AFTER RAWTODIGI STEP - IO
...
#COMMENT OUT FOLLOWING LINES TO RUN ON DATA/SIMTPG STEP  (Data is more useful than simulations anyways)- IO
#L1CaloTowerProducer = cms.EDProducer("L1CaloTowerProducer",
